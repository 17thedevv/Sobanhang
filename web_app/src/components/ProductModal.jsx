...
import { X, Plus, Trash2, Tag, Percent, Archive, Package, Barcode } from 'lucide-react';
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <div className="input-with-icon">
                  ...
                  <input type="text" className="input-field pl-8" value={barcode} onChange={e => setBarcode(e.target.value)} placeholder="Tự động sinh nếu để trống" />
                </div>
              </div>
            </div>
          </div>
          ...
          {!enableVariants && (
            <div className="form-section">
              ...
              <div className="toggle-group mb-3">
                ...
                <span className="toggle-label">Theo dõi tồn kho</span>
              </div>
              {trackInventory && (
                <div className="form-group" style={{maxWidth: '200px'}}>
                  <label>Tồn kho ban đầu</label>
                  <input type="number" min="0" className="input-field" value={stock} onChange={e => setStock(e.target.value)} />
                </div>
              )}
            </div>
          )}
